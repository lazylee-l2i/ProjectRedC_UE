...
#include "RedCRangedAttackAbility.generated.h"

/**
 * 
 */
UCLASS()
class PROJECTREDC_API URedCRangedAttackAbility : public URedCProjectileAbility
{
	GENERATED_BODY()
...
private:
	...
	UPROPERTY(EditDefaultsOnly, Category = "CustomValues|Event")
